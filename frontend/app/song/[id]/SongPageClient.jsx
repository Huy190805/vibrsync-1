...
import LyricsPopup from "@/components/lyrics/LyricsPopup"; 

export default function SongPageClient({ song, artist, relatedSongs, topSongs }) {
  ...
  return (
    <div className="space-y-12 pb-24 max-w-6xl mx-auto px-4">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
           ...
           <button
            ...
            <div className="absolute z-50 mt-2 right-0 w-64 bg-purple-900 text-white rounded-lg shadow-lg border border-purple-700 p-4">
          ...
          className="hover:bg-purple-700 rounded p-2 cursor-pointer"
        >
          Lyrics
        </li>
        <li
     ...
     {/* ✅ Popup lyrics render bên ngoài menu để không bị mất */}
     {showLyricsPopup && (
     <div className="absolute top-0 left-full ml-2 z-50">
      ...
      {/* ✅ Top Songs – SÁT bên dưới relatedSongs */}
      <div className="mt-6">
