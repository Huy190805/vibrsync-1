// frontend/components/top100/GenreSongList.jsx
"use client";
            ...
            >
              ...
              <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <Link href={`/song/${song.id}`}>
                  <span className="font-semibold truncate text-white hover:underline cursor-pointer">
                    {song.title}
                  </span>
                </Link>

                {/* Tên nghệ sĩ (không phải là link nữa) */}
                <span className="text-base font-semibold text-gray-400 truncate hover:text-white transition-colors duration-200 cursor-default">
