// File: components/home/hot-albums.jsx
import Image from "next/image";
import Link from "next/link";
import PlayAlbumButton from "@/components/album/play-album-button";

export default function HotAlbums({ albums }) {
  const topAlbums = (albums || []).slice(0, 10); // Limit to top 10
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex space-x-4 overflow-x-auto pb-2 no-scrollbar">
        {topAlbums.map((album) => (
          <div key={album.id} className="relative group flex-none w-44 md:w-48">
            ...
            <h3 className="text-sm font-medium text-center text-white truncate mt-2">
              {album.title}
            </h3>
